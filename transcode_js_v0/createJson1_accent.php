<?php
/* createJson1.php ejf Feb 3, 2024. Revised location of transcoder.php
...
require_once('utilities_accent/transcoder.php');  // 02-07-2024
...
function initTranscoderJson_Helper($from,$to,$fp) {
    ...
    // TEMPORARY so output easier to read
    $json = preg_replace('|{|', "\n{", $json);
    fwrite($fp,$json);
    fwrite($fp,"\n");
    fwrite($fp,";");
