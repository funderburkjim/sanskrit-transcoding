...
$nprev=12;
$nnext=12;
//echo "monierlist: key1=$key1, direction=$direction, lnum1=$lnum1, nprev=$nprev, nnext = $nnext<br/>";
if ($direction == 'UP') {
...
$recarr = dal_mwkeys2($lnum1,$lnum2);
$matches=array();
$nmatches=0;
foreach($recarr as $rec) {
 list($key3,$lnum3,$data3) = $rec;
