...
while($i < count($listmatches)) {
 ...
 $out1 = "$spc<a  onclick='getWordAlt_keyboard(\"<SA>$key2</SA>\");'><span style='$c'><SA>$key2show</SA></span>$hom2</a><br/>\n";
...
foreach($recarr as $rec) {
  ...
  // Apr 14, 2013 commented out next line. Consider example avata
